<?php
	...
	$execute = mysql_query("SELECT it_imei.imei_id, it_user.name, it_imei.login_last, it_imei.time_entry FROM it_imei LEFT OUTER JOIN it_user ON (it_imei.user_id=it_user.user_id) ORDER BY `time_entry` DESC", $link);	
