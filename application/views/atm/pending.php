...
<div id="body">
	<div class="container">
    <h1>Management ATM (Postponed) <span><form method="post" name="search_box" id="search-box" action="<?php echo base_url() ?>index.php/process/search/atm_pending" onsubmit="return searchbox()"><input type="text" name="q" class="searchbox" maxlength="100" placeholder="Search.." value="<?php echo $search[0]->keyword ?>"></form><a href="<?php echo base_url() ?>index.php/main/atm_app">&radic; Approval</a> <a class="submit" href="<?php echo base_url() ?>index.php/main/atm">ATM Task</a></span></h1>
    ...
    <tbody>
        ...
        <tr id="list_atm_<?php echo $list->atm_id ?>">
            ...
            <a rel="if_close" url="<?php echo base_url() ?>index.php/form/view/atm_pending/<?php echo $list->atm_id ?>"><img src="<?php echo base_url() ?>static/i/icon_message.png" title="Message" style="vertical-align:middle"></a>
            </td>
	...
	if($Qpaging->num_rows > $limit) $this->ifunction->paging($p, base_url().'index.php/main/atm_pending/'.$t.'/', $num_page, $Qpaging->num_rows, 'href', '/'.$s);
	}else{
