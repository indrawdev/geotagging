...
<title>Preload ATP Ericsson 3G (Page 2) - <?php echo $title ?></title>
<style type="text/css">
@page{
  margin: 0;
}
...
<?php $Qchapter = $this->db->query("SELECT `no_chapter`, `content` FROM `it_atp_chapter` WHERE `atp_id`='$dx' AND `chapter`='1' ORDER BY `atp_chapter_id` ASC"); foreach($Qchapter->result_object() as $chapter){
...
<?php echo '<br />';
for($i=0; $i <= 8; $i++){
    echo '<input type="radio" name="no_chapter_1_'.($i+1).'" value="OK" '; if($arr_chapter_1[$i]->content=='OK') echo 'checked="checked"'; echo '><br />';
...
<?php echo '<br />';
for($i=0; $i <= 8; $i++){
    echo '<input type="radio" name="no_chapter_1_'.($i+1).'" value="Not OK" '; if($arr_chapter_1[$i]->content=='Not OK') echo 'checked="checked"'; echo '><br />';
    if(($i==0)||($i==4)||($i==6)) echo '<br />';
}
?>
</td><td valign="top" align="center">
<?php echo '<br />';
for($i=0; $i <= 8; $i++){
    echo '<input type="radio" name="no_chapter_1_'.($i+1).'" value="N/A" '; if($arr_chapter_1[$i]->content=='N/A') echo 'checked="checked"'; echo '><br />';
    if(($i==0)||($i==4)||($i==6)) echo '<br />';
}
?>
</td><td valign="top" align="center">
...
<tr>
    ...
    <td valign="top" width="30" align="center"><br /><input type="radio" name="no_chapter_2_1" value="OK" <?php if($arr_chapter_2[0]->content=='OK') echo 'checked="checked"'; ?> /></td>
    <td valign="top" width="40" align="center"><br /><input type="radio" name="no_chapter_2_1" value="Not OK" <?php if($arr_chapter_2[0]->content=='Not OK') echo 'checked="checked"'; ?> /></td>
    <td valign="top" width="35" align="center"><br /><input type="radio" name="no_chapter_2_1" value="N/A" <?php if($arr_chapter_2[0]->content=='N/A') echo 'checked="checked"'; ?> /></td>
...
<?php echo '<br />';
for($i=0; $i <= 6; $i++){
	echo '<input type="radio" name="no_chapter_3_'.($i+1).'" value="OK" '; if($arr_chapter_3[$i]->content=='OK') echo 'checked="checked"'; echo '><br />';
}
?>
</td><td width="40" valign="top" align="center">
<?php echo '<br />';
for($i=0; $i <= 6; $i++){
	echo '<input type="radio" name="no_chapter_3_'.($i+1).'" value="Not OK" '; if($arr_chapter_3[$i]->content=='Not OK') echo 'checked="checked"'; echo '><br />';
}
?>
</td><td width="35" valign="top" align="center">
<?php echo '<br />';
for($i=0; $i <= 6; $i++){
	echo '<input type="radio" name="no_chapter_3_'.($i+1).'" value="N/A" '; if($arr_chapter_3[$i]->content=='N/A') echo 'checked="checked"'; echo '><br />';
}
?>
...
<tr>
    ...
    <td valign="top" width="30" align="center"><br /><input type="radio" name="no_chapter_4_1" value="OK" <?php if($arr_chapter_4[0]->content=='OK') echo 'checked="checked"'; ?> /></td>
    <td valign="top" width="40" align="center"><br /><input type="radio" name="no_chapter_4_1" value="Not OK" <?php if($arr_chapter_4[0]->content=='Not OK') echo 'checked="checked"'; ?> /></td>
    <td valign="top" width="35" align="center"><br /><input type="radio" name="no_chapter_4_1" value="N/A" <?php if($arr_chapter_4[0]->content=='N/A') echo 'checked="checked"'; ?> /></td>
    <td valign="top" width="90" align="center"><br />Major</td>
</tr>
</table>
...
if(isset($_POST['kirim']))
{
	...
	{
		$chp = 'no_chapter_1_'.$i;
		if(isset($$chp)) $quest[] = '1|No|1.'.$i.'|'.$$chp; else { $$chp = "null"; $quest[] = '1|No|1.'.$i.'|'.$$chp; }
	}
	
	for($i=1; $i<=4; $i++)
	{
		$chp = 'no_chapter_1_'.($i+5);
		if(isset($$chp)) $quest[] = '1|No|1.6.'.$i.'|'.$$chp; else { $$chp = "null"; $quest[] = '1|No|1.6.'.$i.'|'.$$chp; }
	}
	
	if(isset($no_chapter_2_1)) $quest[] = '2|No|2.1|'.$no_chapter_2_1; else { $quest[] = '2|No|2.1|null'; }
	
	for($i=1; $i<=7; $i++)
	{
		$chp = 'no_chapter_3_'.$i;
		if(isset($$chp)) $quest[] = '3|No|3.'.$i.'|'.$$chp; else { $$chp = "null"; $quest[] = '3|No|3.'.$i.'|'.$$chp; }
	}
	
	if(isset($no_chapter_4_1)) $quest[] = '4|No|4.1|'.$no_chapter_4_1; else { $quest[] = '4|No|4.1|null'; }
	
	for($i=1; $i<=5; $i++)
	{
		$chp = 'no_chapter_5_'.$i;
		if(isset($$chp)) $quest[] = '5|No|5.'.$i.'|'.$$chp; else { $$chp = "null"; $quest[] = '5|No|5.'.$i.'|'.$$chp; }
	}
