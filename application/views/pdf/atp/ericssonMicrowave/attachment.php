...
function main_name($dx){
	switch($dx){
		...
		case '8.1': return 'Measurement will be check to meet transport 20 Mbps or 31 Mbps'; break;
		case '8.2': return 'QOS test'; break;
		case '9': return 'Alarm Check'; break;
		case '10': return 'Quality Test (BER *)'; break;
		case '11': return 'Environment Check'; break;
		case '12.0': return 'Traffic Class Value'; break;
		case '12.1': return 'Attachment Checking'; break;
...
function sub_name($dx, $sub){
	switch($dx){
		...
		case 8.1:
		switch($sub){
			case 1: return 'Troughput'; break;
			case 2: return 'Delay'; break;
			case 3: return 'Jitter'; break;
		}
		break;
		...
		case '12.0':
		switch($sub){
			case 1: return 'Traffic Class 0'; break;
			case 2: return 'Traffic Class 1'; break;
			case 3: return 'Traffic Class 2'; break;
			case 4: return 'Traffic Class 3'; break;
			case 5: return 'Traffic Class 4'; break;
			case 6: return 'Traffic Class 5'; break;
			case 7: return 'Traffic Class 6'; break;
			case 8: return 'Traffic Class 7'; break;
		}
		break;
		
		case '12.1':
		switch($sub){
			case 1: return 'Bill Of Quantity (BOQ) as Equipment Inv.'; break;
			case 2: return 'Save Report and configuration'; break;
			case 3: return 'Module Inventory capture **)'; break;
			case 4: return 'Link Calculation (Link Budget)'; break;
			case 5: return 'BER Test Result *)'; break;
			case 6: return 'Engineering Table'; break;
			case 7: return 'Installation Check'; break;
			case 8: return 'Scan Frequency***)'; break;
		}
		break;
