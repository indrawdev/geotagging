...
<title>Preload ATP Ericsson 2G (Page 18) - <?php echo $title ?></title>
<style type="text/css">
@page{
  margin: 0;
}
...
<?php echo '<br /><br />';
for($i=0; $i <= 2; $i++){
    echo '<input type="radio" name="no_chapter_26.'.($i+1).'" value="OK"'; if($arr_chapter_26[$i]->content=='OK') echo 'checked="checked"'; echo ' /><br />';
}
?>
</td><td valign="top" align="center">
<?php echo '<br /><br />';
for($i=0; $i <= 2; $i++){
    echo '<input type="radio" name="no_chapter_26.'.($i+1).'" value="Not OK"'; if($arr_chapter_26[$i]->content=='Not OK') echo 'checked="checked"'; echo ' /><br />';
}
?>
</td><td valign="top" align="center">
<?php echo '<br /><br />';
for($i=0; $i <= 2; $i++){
    echo '<input type="radio" name="no_chapter_26.'.($i+1).'" value="N/A"'; if($arr_chapter_26[$i]->content=='N/A') echo 'checked="checked"'; echo ' /><br />';
}
?>
...
<center>
    ...
    <input type="button" class="button" name="next" value="Save" onclick="validasi(19, <?php echo $dx ?>)" />
...
<?php
	if(isset($_POST['kirim']))
	{
		...
		for($i=1; $i<=3; $i++)
		{
			$chp = 'no_chapter_26_'.$i;
			if(isset($$chp)) $quest[] = '26|No|26.'.$i.'|'.$$chp;
		}
